...
<script>
    window.ovhvps = {
        ...
        lang: {
            ...
            images_loading: "{$lang.js_images_loading|default:'Loading all operating systems…'|escape:'javascript'}",
            images_failed: "{$lang.js_images_failed|default:'Could not load the operating system list.'|escape:'javascript'}",
            images_retry: "{$lang.js_images_retry|default:'Try again'|escape:'javascript'}",
