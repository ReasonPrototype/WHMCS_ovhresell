...
$_LANG['js_images_loading'] = 'Loading all operating systems…';
$_LANG['js_images_failed'] = 'Could not load the operating system list.';
$_LANG['js_images_retry'] = 'Try again';
$_LANG['js_no_snapshot'] = 'No snapshot exists yet.';
$_LANG['js_snapshot'] = 'Snapshot';
$_LANG['js_present'] = 'present';
$_LANG['js_snapshot_creating'] = 'Snapshot is being created; this can take a minute. This panel refreshes automatically.';
$_LANG['js_option_locked'] = 'This feature is a paid option that is not part of your current plan. Add it to unlock this tab.';
$_LANG['js_option_buy'] = 'Add this option';
...
$_LANG['js_restore'] = 'Restore';
$_LANG['js_restore_point'] = 'Restore point';
$_LANG['js_confirm_restore'] = 'Restoring overwrites ALL current data on the VPS with the selected backup. Continue?';
$_LANG['js_no_restore_points'] = 'No restore points available.';
